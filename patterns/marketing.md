...
- **Feature hero:** full-viewport dark hero, centered copy, optional Meta badge, white CTA, and one product mockup anchored below the copy. For DM automation, use real Flow Builder / Instagram DM visual references as the backdrop; reserve scenic/editor backgrounds for Link in Bio and AI FAQ pages that actually use them.
...
- **Movable feature asset boards:** use large 55px rounded dark panels with short benefit copy and draggable internal assets: message tiles, triage cards, orbit dots, language chips, spheres, or globes. Keep movement bounded to the visual module and preserve a good static composition before interaction.
