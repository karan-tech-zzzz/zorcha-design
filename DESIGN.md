...
- Free comment-to-DM pages should explain the public comment trigger, keyword match, private DM, setup proof, and safety. Do not turn them into pricing or plan-comparison pages unless the brief asks for that job.
